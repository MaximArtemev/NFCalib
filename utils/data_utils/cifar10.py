...
from utils.data_utils import misc_utils
...
class CIFAR10:
    ...
    class Data:
        ...
        def __init__(self, x, l, logit, flip, dequantize, rng):
            ...
            self.y = misc_utils.one_hot_encode(self.labels, 10)  # 1-hot encoded labels
        ...
        def _logit_transform(x):
            ...
            """
            return misc_utils.logit(CIFAR10.alpha + (1 - 2 * CIFAR10.alpha) * x)
    ...
    def __init__(self, logit=False, flip=False, dequantize=True):
        ...
        path = join(definitions.DATA_DIR, 'cifar10/')
    ...
    def show_images(self, split):
        ...
        misc_utils.disp_imdata(x, self.image_size, [6, 10])
